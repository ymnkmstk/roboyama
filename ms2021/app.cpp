            ...
            .composite<BrainTree::ParallelSequence>(1,2)
                ...
                .composite<BrainTree::MemSequence>()
                    ...
                    .composite<BrainTree::ParallelSequence>(1,2)
                        ...
                        .leaf<IsVariableTimeEarned>(-1,180,false)
                        .leaf<RunAsInstructed>(84,85, 4.5)
                    .end()
                    .composite<BrainTree::ParallelSequence>(1,2)
                        //.leaf<IsTimeEarned>(210)
                        .leaf<IsTimeEarned>(50)
                        .leaf<RunAsInstructed>(85,84, 1)
                    .end()
                    ...
                    .composite<BrainTree::ParallelSequence>(1,2)
                        .leaf<IsTimeEarned>(5)
                        .leaf<RunAsInstructed>(70,70, 5.2)
                    .end()
                    //上記でBlack_についていない場合のみ発動
                    // .composite<BrainTree::ParallelSequence>(1,2)
                    //     .leaf<IsTargetColorDetected>(Black_3)
                    //     //.leaf<IsTimeEarned>(47)
                    //     .leaf<RunAsInstructed>(75,35, 3)
                    // .end()
                    ...
                    .composite<BrainTree::ParallelSequence>(1,2)
                        ...
                        //.leaf<IsVariableTimeEarned2>(-0.0033,0.6934,70.691)
                        //.leaf<IsVariableTimeEarned2>(0.0031,0.3259,74.744)
                    ...
                    // .end()
                    .composite<BrainTree::ParallelSequence>(1,2)
                        .leaf<IsTimeEarned>(35)//ここを可変にしたい
