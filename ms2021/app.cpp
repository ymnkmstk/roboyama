        ...
        tr_run = (BrainTree::BehaviorTree*) BrainTree::Builder()
            .composite<BrainTree::ParallelSequence>(1,2)
                ...
                .composite<BrainTree::MemSequence>()
                    ...
                    .composite<BrainTree::ParallelSequence>(1,2)
                        .leaf<IsTimeEarned>(135)
                        .leaf<RunAsInstructed>(85,27, 0.65)
                    .end()
                    // .composite<BrainTree::ParallelSequence>(1,2)
                    //     .leaf<IsTimeEarned>(20)
                    //     .leaf<RunAsInstructed>(85,20, 0)
                    // .end()
        ...
        tr_run = (BrainTree::BehaviorTree*) BrainTree::Builder()
            .composite<BrainTree::ParallelSequence>(1,2)
                ...
                .composite<BrainTree::MemSequence>()
                    ...
                    //最後のストレートへの回り
                    .composite<BrainTree::ParallelSequence>(1,2)
                        .leaf<IsTimeEarned>(30)//24
                        .leaf<RunAsInstructed>(100,30, 2.5)//25
                    .end()
                    .composite<BrainTree::ParallelSequence>(1,2)
                    ...
                    .composite<BrainTree::ParallelSequence>(1,2)
                        ...
                        .leaf<RunAsInstructed>(100,28, 3)
                    .end()
                    .composite<BrainTree::ParallelSequence>(1,2)
                        .leaf<IsTimeEarned>(280)
                        .leaf<RunAsInstructed>(100,100, 2.4)
                    .end()
